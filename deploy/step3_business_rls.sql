-- ============================================================================
-- DEPLOIEMENT — ETAPE 3 : Metier Sprint 2+3 + RLS
-- Coller INTEGRALEMENT dans l'editeur SQL Supabase, puis RUN.
-- Contient : 0004, 0005, 0006, 0007
...
-- Table : audit_logs
-- ---------------------------------------------------------------------------
-- Créée AVANT `log_audit()` : une fonction `language sql` voit son corps
-- validé dès sa création (check_function_bodies), la table doit donc exister.
-- ===========================================================================
